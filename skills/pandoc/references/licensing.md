...
`pandoc-core.mjs` in this skill is an esbuild bundle of `pandoc-wasm/src/core.js` (GPL-2.0-or-later). Runtime installs `pandoc-wasm@1.1.0` for the `pandoc.wasm` binary.
