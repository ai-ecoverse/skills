...
tiktok filmstrip  <videoId|url> [--frames=8] [--width=160] [--out=path] [--json]
tiktok see      <videoId|url> [--frames=8] [--lang=eng-US] [--dir=path] [--json]
...
| `--seek-wait` | filmstrip | 700 | ms to wait after each seek for the frame to decode |
